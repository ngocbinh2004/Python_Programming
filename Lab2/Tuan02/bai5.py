...
buttons_frame = ttk.LabelFrame(win, text='Labels in a Frame', style="Blue.TLabelframe")
buttons_frame.grid(column=0, row=7)

# Center Label2 and Label3
ttk.Label(buttons_frame, text="Label1 – so much longer...").grid(column=0, row=0, sticky=tk.W)
ttk.Label(buttons_frame, text="Label2").grid(column=0, row=1, sticky=tk.W, padx=(50, 0))
ttk.Label(buttons_frame, text="Label3").grid(column=0, row=2, sticky=tk.W, padx=(50, 0))
